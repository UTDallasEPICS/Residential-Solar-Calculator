    ...
    useEffect(() => {
        ...
        if (searchTerm.trim() === '') {
            ...
            const filtered = faqs.filter(faq => {
                ...
                return faq.question.toLowerCase().includes(lowerTerm) ||
    ...
    return (
        <div className="faq-section">
            ...
            <div className="search-container">
                ...
                />
                <button id="clear-search" onClick={() => setSearchTerm('')}>Clear</button>
            </div>
            {filteredFAQs.length === 0 && (
                <div id="no-results" style={{ display: 'block' }}>No results found</div>
            )}
