  ...
  return (
    <PageContainer>
      <Section>
        ...
        <Text>
          This section will display the calculated size of the solar panel
          system required based on the annual energy usage input. It may include
          details like total kW needed and estimated costs.
        </Text>
        <InfoBox>
      ...
      <Section>
        ...
        <Text>
          Here, the required battery size to support the solar system will be
          shown. This could include battery capacity in kWh and number of
      ...
      <Section>
        ...
        <Text>
          Here, the optimal battery and solar panel sizes are taken into account
